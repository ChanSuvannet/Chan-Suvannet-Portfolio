          ...
          <div>
            <div>
              <div className="flex flex-col items-center justify-center">
                <div className="w-44 h-44 rounded-full flex justify-center items-center border-[10px] border-red-300 hover:border-red-400 hover:bg-red-200 cursor-pointer">
                  <img
                    src={Profile}
                    alt={Profile}
              ...
              <div className="flex justify-center items-center pt-5">
                <button className="bg-red-300 hover:bg-red-200 max-600:w-[145px] max-600:h-[44px] ">Hire Me</button>
              </div>
            </div>
          </div>
